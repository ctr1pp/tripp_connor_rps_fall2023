...
# the position of the rock, paper, and scissors images 
show_rock(-300, 0)
show_paper(0, 0)
show_scissors(300, 0) 

#the place and look of the "Choose rock or paper of scissors"
text.penup()
text.setpos(-100,150)
text.write("Choose rock or paper or scissors", False, "left", ("Arial", 24, "normal"))

# tells the computer to write 'rock' and its position 
text.setpos (-300,150)
text.write('rock')

# tells the computer to write 'paper' and its position 
text.setpos (0,120)
text.write('paper')

# tells the computer to write 'scissors' and its position 
text.setpos(300,100)
text.write('scissors')
...
# tells what the computer chose 

   # the computers response to you choosing rock 
    if collide(x,y,rock_instance, rock_w, rock_h):
        ...
        # response to the computer choosing rock 
        if compchose == "Rock":
            clearimages()
            text2.penup()
            text2.setpos(160,0)
            ...
            c.setpos(300,0)
        # response to the computer choosing paper
            ...
            rock_instance.setpos(-300,0)
            c.setpos(300,0)
        # response to the computer choosing scissors
    ...
    # the computers response to you choosing paper
        ...
        # response to the computer choosing paper
            ...
            text2.penup()
            text2.setpos(155,0)
            text2.write("You both chose paper, you die.", True, "right", ("Arial",16,"normal"))
            paper_instance.showturtle()
            c = paper_instance.clone()
            c.showturtle()
            paper_instance.setpos(-300,0)
    ...
    # the computers response to you choosing scissors 
